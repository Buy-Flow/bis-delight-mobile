    ...
    <>
      ...
      <div className="fixed left-4 z-[60] md:bottom-4" style={bottomStyle}>
        <a
          ...
          className="grid h-11 w-11 place-items-center rounded-full bg-[#25D366] text-white shadow-2xl touch-manipulation [-webkit-tap-highlight-color:transparent] transition-transform duration-100 ease-out active:scale-95 animate-pulse-glow"
        >
      ...
      >
        <button
          ...
          className="flex items-center gap-1.5 rounded-full bg-neon-pink px-3 h-11 text-white font-bold shadow-2xl glow-pink touch-manipulation [-webkit-tap-highlight-color:transparent] transition-transform duration-100 ease-out active:scale-95"
        >

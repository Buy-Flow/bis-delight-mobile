  ...
  return (
    <div className="fixed inset-x-4 bottom-4 z-30 flex flex-row-reverse items-center gap-3">
      <a
        ...
        className="grid h-14 w-14 shrink-0 place-items-center rounded-full bg-[#25D366] text-white shadow-2xl touch-manipulation [-webkit-tap-highlight-color:transparent] transition-transform duration-100 ease-out active:scale-95 animate-pulse-glow"
      >

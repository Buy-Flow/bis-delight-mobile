...
export function HighlightCard({
  ...
  return (
    <div className="relative flex h-full overflow-hidden rounded-[28px] border border-white/10 bg-[oklch(0.16_0.10_305)] shadow-[0_18px_40px_-12px_rgba(0,0,0,0.6)]">
      ...
      {/* Left image — larger */}
      <div className="relative w-[54%] shrink-0 overflow-hidden bg-gradient-to-br from-[oklch(0.22_0.14_305)]/60 to-transparent">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_55%,oklch(0.72_0.26_350_/_0.18),transparent_70%)]" />
        <img
          src={product.image}
          alt={product.name}
          loading="lazy"
          className="absolute inset-0 h-full w-full scale-125 object-contain drop-shadow-[0_20px_20px_rgba(0,0,0,0.6)]"
        />
      </div>

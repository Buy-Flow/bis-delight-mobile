...
export function BottomNav() {
  ...
  const hiddenPrefixes = ["/rush", "/carrinhos", "/clientes", "/financeiro", "/notificacoes", "/admin", "/auth", "/previsao", "/copiloto", "/ai-growth", "/rastrear", "/avaliacoes", "/precificacao", "/lucratividade", "/modelos", "/entregas", "/pdv", "/garcons", "/impressao", "/biblioteca"];

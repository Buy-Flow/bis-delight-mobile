...
export function Hero({
  ...
  return (
    <section className="relative overflow-x-clip px-4 pb-0 pt-2">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 z-0 overflow-x-clip lg:left-1/2 lg:right-auto lg:w-screen lg:-translate-x-1/2"
      >
        ...
        {/* No bottom fade — the hero glow bleeds naturally into the page
            background so the whole surface reads as one continuous purple. */}

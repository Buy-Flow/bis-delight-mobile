  ...
  return (
    <section className="relative overflow-hidden px-4 pb-0 pt-2">
      ...
      <img
        ...
        src={heroBgLeft.url}
        alt=""
        className="pointer-events-none absolute -left-6 -top-32 z-0 h-[980px] w-auto max-w-none select-none object-contain object-left"
      />
      <img
        aria-hidden="true"
        src={heroBgRight.url}
        alt=""
        className="pointer-events-none absolute -right-6 -top-40 z-0 h-[980px] w-auto max-w-none select-none object-contain object-right"
      ...
      <div className="relative z-20 mx-auto flex w-[220px] max-w-full flex-col items-center text-center">
        ...
        <div className="mt-5 flex flex-col items-center gap-2">
          <span
            className="text-[26px] leading-none text-neon-yellow"
            style={{

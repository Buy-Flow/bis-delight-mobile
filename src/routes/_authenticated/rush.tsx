  ...
  return (
    <div className="min-h-screen bg-background pb-32 text-white">
      ...
      <main className="mx-auto w-full max-w-6xl px-3 pt-3 pb-6 md:px-6 lg:px-8">
        ...
        {/* Lane list */}
        <section className="mt-3 grid gap-2.5 md:grid-cols-2 2xl:grid-cols-3">
          {orders === null ? (
      ...
      <div className="mt-3 flex flex-wrap items-stretch gap-2">
        {!done && (order.status === "preparando" || order.status === "saiu_para_entrega" || order.status === "pago") && (
          <button
            ...
            onClick={onRevert}
            disabled={busy}
            className="grid w-12 shrink-0 place-items-center rounded-2xl border border-white/15 bg-white/5 text-white/70 hover:bg-white/10"

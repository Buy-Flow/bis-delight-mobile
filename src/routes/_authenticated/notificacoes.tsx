...
// Duration options in minutes (null = never expires)
...
function NotificacoesPage() {
  ...
  const [durationMin, setDurationMin] = useState<number | null>(60 * 24); // default: 24h
...
function EditCampaignModal({
  ...
  // Duration relative to now (or keep existing)
      ...
      >
        ...
        <div className="space-y-3 p-4">
          ...
          <div>
            ...
            <p className="mt-1 text-[10px] text-white/40">
              A alteração é apenas no histórico do site. A notificação push já entregue não é retirada do sistema do celular.
            </p>
          </div>
        </div>

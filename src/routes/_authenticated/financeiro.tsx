...
import { FinanceDashboardSkeleton } from "@/components/skeleton";
...
function Heatmap({
  ...
  return (
    <div>
      {/* Dias em cima, horas na lateral — cabe inteiro sem rolar */}
      <div
        className="grid gap-1 text-[10px] font-bold uppercase tracking-widest text-white/50"
      ...
      <div className="mt-1 space-y-1">
        {hours.map((h) => (
          <div
            ...
            style={{ gridTemplateColumns: `40px repeat(7, minmax(0,1fr))` }}
          >
            <div className="flex items-center justify-end pr-1 text-[10px] font-bold tabular-nums text-white/50">
            ...
            {DOW.map((label, dow) => {
              ...
              return (
                <div
                  ...
                  className="grid h-6 place-items-center rounded-md border border-white/5 text-[9px] font-bold text-white/90 transition-transform hover:scale-110"
                  style={{

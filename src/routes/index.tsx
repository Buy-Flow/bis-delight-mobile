...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://querobis.lovable.app/" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [{ rel: "canonical", href: "https://querobis.lovable.app/" }],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          image: "https://querobis.lovable.app/pwa-512.png",
          servesCuisine: ["Sorvete", "Açaí", "Milk Shake"],
          priceRange: "$$",
          address: {
            "@type": "PostalAddress",
          ...
          areaServed: "Ouro Preto do Oeste - RO",
        }),
      },
    ],
  }),
